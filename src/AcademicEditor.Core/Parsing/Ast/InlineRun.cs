...
/// suprime caractere nenhum. Fica de fora dos runs apenas o que separa blocos: o <c>\n</c> entre
/// duas linhas e o <c>\r</c> de uma fonte ainda em CRLF.
/// </para>
/// <para>
/// A marcação de bloco — o <c>## </c> de um heading — é um run como outro qualquer, marcado com
/// <see cref="IsMarkup"/>. O parser sempre a emite; quem decide se ela aparece é o layout, que a
/// revela na linha onde o caret está. Isso é o que faz o caret andar sobre o <c>#</c> como sobre
/// qualquer letra, em vez de existir uma posição no arquivo sem posição na tela.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public readonly record struct InlineRun(string Text, int SourceStart, TextStyle Style, bool IsMarkup = false)
{
